...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}body{margin:0}.shell{max-width:1120px;margin:0 auto;padding:28px 24px 56px}
        ...
        .hero{display:grid;grid-template-columns:minmax(0,1.2fr) minmax(320px,.8fr);gap:56px;align-items:center}.kicker{color:#00a5b5;font-size:12px;font-weight:900;letter-spacing:.18em;text-transform:uppercase}.hero h1{font-size:clamp(38px,5vw,68px);line-height:1.08;letter-spacing:0;margin:14px 0 20px}.hero p{font-size:17px;line-height:1.8;color:#65758d;max-width:650px}.actions{display:flex;gap:12px;flex-wrap:wrap;margin-top:28px}.actions form{margin:0}.button{display:inline-flex;align-items:center;justify-content:center;min-height:44px;padding:0 20px;border-radius:6px;border:0;text-decoration:none;font-weight:800;font-size:14px;cursor:pointer}.primary{background:#1769ff;color:#fff}.secondary{border:1px solid #cad5e5;background:#fff;color:#25344b}
